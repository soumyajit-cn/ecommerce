                            ...
                            <div class="simpleLens-gallery-container" id="demo-1">
                              <div class="simpleLens-container">
                                  <div class="simpleLens-big-image-container">
                                      <a class="simpleLens-lens-image" data-lens-image="{{ asset('user/img/view-slider/large/polo-shirt-1.png') }}">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-recently-views">
                <ul>
                  ...
                  <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ asset('user/img/woman-small-1.jpg') }}"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="#">Product Name</a></h4>
                      <p>1 x $250</p>
                    </div>
                   ...
                   <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ asset('user/img/woman-small-2.jpg') }}"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="#">Product Name</a></h4>
                      <p>1 x $250</p>
                    </div>
