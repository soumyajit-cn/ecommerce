        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{route('products.update',$product->id)}}" method="post" enctype="multipart/form-data" class="">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class=" col form-group">
                                <div class="input-group">
                                    ...
                                    <input type="number" value="{{$product->product_price_before_discount}}" name="product_price_before_discount" class="form-control @error('product_price_before_discount') is-invalid @enderror">
                                    <div class="input-group-addon">
                                        <i class="fa fa-inr"></i>
                                    </div>
                                </div>
                            ...
                            <div class=" col form-group">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="product_price" value="{{$product->product_price}}"  class="form-control @error('product_price') is-invalid @enderror">
                                    <div class="input-group-addon">
                                        <i class="fa fa-inr"></i>
                                    </div>
                                </div>
                            ...
                            <div class=" col form-group">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="order_limit" value="{{ $product->order_limit}}"  class="form-control @error('order_limit') is-invalid @enderror">
                                    <div class="input-group-addon">
                        ...
                        <div class=" form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="keywords" value="{{ json_decode($product->keywords)}}"  class="form-control @error('keywords') is-invalid @enderror" placeholder="Please use ,(Comma) as keywords separator">
                                <div class="input-group-addon">
                                    <i class="fa fa-key"></i>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <div class="col-12 col-md-10">
                                    <textarea name="product_description" id="textarea-input" rows="3" placeholder="Content..." class="form-control @error('product_description') is-invalid @enderror">{{ $product->product_description}}</textarea>
